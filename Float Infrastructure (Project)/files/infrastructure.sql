...
-- object: "Infrastructure Spinner".compute_servers | type: TABLE --
-- DROP TABLE IF EXISTS "Infrastructure Spinner".compute_servers;
CREATE TABLE "Infrastructure Spinner".compute_servers(
	hostname text NOT NULL,
	t_cores integer NOT NULL,
	t_cores_committed integer NOT NULL,
	f_cores smallint NOT NULL,
...
TABLESPACE pg_default;
-- ddl-end --
ALTER TABLE "Infrastructure Spinner".compute_servers OWNER TO db_admin;
-- ddl-end --

-- object: "Infrastructure Spinner".memory_servers | type: TABLE --
-- DROP TABLE IF EXISTS "Infrastructure Spinner".memory_servers;
CREATE TABLE "Infrastructure Spinner".memory_servers(
	hostname text NOT NULL,
	t_memory integer NOT NULL,
	t_memory_committed integer NOT NULL,
	f_memory integer NOT NULL,
	ip_addr text NOT NULL,
	CONSTRAINT memory_servers_pk PRIMARY KEY (hostname)

)
TABLESPACE pg_default;
-- ddl-end --
ALTER TABLE "Infrastructure Spinner".memory_servers OWNER TO db_admin;
-- ddl-end --

-- object: "Infrastructure Spinner".storage_servers | type: TABLE --
-- DROP TABLE IF EXISTS "Infrastructure Spinner".storage_servers;
CREATE TABLE "Infrastructure Spinner".storage_servers(
	hostname text NOT NULL,
	t_storage integer NOT NULL,
	t_storage_committed integer NOT NULL,
	f_storage integer NOT NULL,
	ip_addr text NOT NULL,
	CONSTRAINT storage_servers_pk PRIMARY KEY (hostname)

)
TABLESPACE pg_default;
-- ddl-end --
ALTER TABLE "Infrastructure Spinner".storage_servers OWNER TO db_admin;
-- ddl-end --

-- object: "Infrastructure Spinner".credentials | type: TABLE --
-- DROP TABLE IF EXISTS "Infrastructure Spinner".credentials CASCADE;
...
-- object: "Infrastructure Spinner".resource_provisioned | type: TABLE --
-- DROP TABLE IF EXISTS "Infrastructure Spinner".resource_provisioned;
CREATE TABLE "Infrastructure Spinner".resource_provisioned(
...
TABLESPACE pg_default;
-- ddl-end --
ALTER TABLE "Infrastructure Spinner".resource_provisioned OWNER TO db_prov;
-- ddl-end --
...
CREATE TABLE "Infrastructure Spinner".pricing(
	cost integer,
	c_nodes_time integer,
	s_nodes_t integer,
	m_nodes_t integer,
	"PID_resource_provisioned" integer NOT NULL
)
TABLESPACE pg_default;
-- ddl-end --
...
CREATE TABLE "Infrastructure Spinner".vm_stats(
	...
	"time" integer,
	CONSTRAINT vm_stats_pk PRIMARY KEY (vmid)

)
TABLESPACE pg_default;
-- ddl-end --
ALTER TABLE "Infrastructure Spinner".vm_stats OWNER TO db_admin;
-- ddl-end --

-- object: resource_provisioned_fk | type: CONSTRAINT --
-- ALTER TABLE "Infrastructure Spinner".pricing DROP CONSTRAINT IF EXISTS resource_provisioned_fk CASCADE;
ALTER TABLE "Infrastructure Spinner".pricing ADD CONSTRAINT resource_provisioned_fk FOREIGN KEY ("PID_resource_provisioned")
REFERENCES "Infrastructure Spinner".resource_provisioned ("PID") MATCH FULL
...
ALTER TABLE "Infrastructure Spinner".pricing ADD CONSTRAINT pricing_uq UNIQUE ("PID_resource_provisioned");
-- ddl-end --

-- object: username | type: CONSTRAINT --
-- ALTER TABLE "Infrastructure Spinner".resource_provisioned DROP CONSTRAINT IF EXISTS username CASCADE;
ALTER TABLE "Infrastructure Spinner".resource_provisioned ADD CONSTRAINT username FOREIGN KEY ("PID")
REFERENCES "Infrastructure Spinner".credentials (username) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: "PID" | type: CONSTRAINT --
-- ALTER TABLE "Infrastructure Spinner".vm_stats DROP CONSTRAINT IF EXISTS "PID" CASCADE;
ALTER TABLE "Infrastructure Spinner".vm_stats ADD CONSTRAINT "PID" FOREIGN KEY (vmid)
REFERENCES "Infrastructure Spinner".resource_provisioned ("PID") MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
