...
{   $eid=$_REQUEST['eid'];
 echo $eid;
    $del="DELETE FROM events WHERE  eid = $eid";
        ...
        <div id="table-div">
            ...
            echo"<tbody>";
                ...
                { 
                    ...
                    echo'<td><form action="" method="post"><input type="hidden" name="eid" value=' . $row['eid'] .'><input class="form-btn" type="submit" name="edit" value="Edit"/><input class="form-btn" type="submit" name="delete" value="Delete"/></form></td>';
                echo"</tr>";  
                }
                   echo"</tbody>";
            echo"</table>";
